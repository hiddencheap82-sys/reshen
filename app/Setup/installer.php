...
// دستورالعمل‌های بعدی (پیامک و الگوها) را هرگز نمی‌بیند.
    ...
    <div class="wrap">
      ...
      <div class="card">
        ...
        <ol>
          ...
          <li><strong>کار زمان‌بندی‌شده‌ای لازم نیست تنظیم کنید.</strong> یادآورها و
              پیامک‌های صف خودشان با بازدیدهای سایت ارسال می‌شوند — نه کرونی، نه
              تنظیمی. وضعیتش را در <code>doctor.php</code> می‌بینید.</li>
        </ol>
