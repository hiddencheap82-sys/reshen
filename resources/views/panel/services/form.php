...
<form method="post" action="<?= url($service ? 'panel/services/' . $service['id'] : 'panel/services') ?>" class="bg-white rounded-2xl border border-ink-100 p-5 space-y-4">
  <?= csrf_field() ?>
  <div>
...
<div class="bg-white rounded-2xl border border-ink-100 p-5 mt-4">
