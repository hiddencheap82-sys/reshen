...
/*
 * کنترلر ممکن است فهرست کوتاه‌تری بدهد: سالنِ تک‌آرایشگر گام «آرایشگر»
 * ندارد، و نواری که چهار گام بگوید و سه گام برود، مشتری را منتظرِ
 * گامی می‌گذارد که نمی‌آید.
 */
$stepTitles = $steps ?? ['زمان', 'خدمت', 'آرایشگر', $lastStep];
$step = $step ?? null;
?>
<!doctype html>
