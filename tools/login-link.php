 ...
 *
 * روی هاستی که SSH ندارد، از ترمینالِ cPanel اجرایش کنید — یا اگر
 * ترمینال هم نیست، یک Cron Jobِ یک‌باره بسازید که فقط همین دستور را
 * اجرا کند و خروجی را ایمیل کند. (برنامه خودش به کرون نیازی ندارد؛
 * این فقط راهی است برای اجرای یک دستور روی هاستِ بی‌ترمینال.)
 */
