...
LIGHT_BG, LIGHT_SURFACE, LIGHT_TEXT = '#F9FAFB', '#FFFFFF', '#111B21'
...
# خاکستری‌های کم‌رنگِ حالت روشن — همان ink-400 و ink-500ِ tailwind.config.js
LIGHT_DIM, LIGHT_DIM_STRONG = '#5D6870', '#4A565D'
HERO = '#102431'

for group, label, fg, bg in [
    ('ثابت', '«تمام شد» روشن',  '#FFFFFF', '#047857'),
    ('ثابت', '«تمام شد» هاور',  '#FFFFFF', '#065F46'),
    ('ثابت', '«تمام شد» تیره',  '#052E22', '#34D399'),
    ('ثابت', '«تمام شد» تیره هاور', '#052E22', '#10B981'),
    ('ثابت', 'قرمزِ هشدار روشن', '#FFFFFF', '#B91C1C'),
    ('حالت تیره', 'قرمزِ هشدار تیره', '#F87171', '#102431'),
    ('حالت تیره', 'متن تیره روی زمینهٔ تیره', DARK_TEXT, DARK_BG),
    ('حالت تیره', 'متن تیره روی سطح تیره',   DARK_TEXT, DARK_SURFACE),
    ('حالت تیره', 'متن کم‌رنگ روی سطح تیره', DARK_DIM,  DARK_SURFACE),
    ('حالت تیره', 'متن کم‌رنگ روی زمینهٔ تیره', DARK_DIM, DARK_BG),
    ('حالت روشن', 'متن روی زمینهٔ روشن',     LIGHT_TEXT, LIGHT_BG),
    ('حالت روشن', 'متن کم‌رنگ روی سطح',      LIGHT_DIM,  LIGHT_SURFACE),
    ('حالت روشن', 'متن کم‌رنگ روی زمینه',     LIGHT_DIM,  LIGHT_BG),
    ('حالت روشن', 'متن کمکی روی زمینه',       LIGHT_DIM_STRONG, LIGHT_BG),
    ('سرصفحه',   'متن سفید روی نفتی',        '#FFFFFF', HERO),
]:
    r = ratio(fg, bg)
    if r < 4.5:
        fails.append((group, label, round(r, 2), 4.5))
    print(f"{group:<12} {label:<34} {r:>6.2f}  {'✓' if r >= 4.5 else '✗ کمتر از 4.5'}")
print()
