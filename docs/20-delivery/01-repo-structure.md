...
│   └── Scheduler.php     کارهای دوره‌ای — با هر درخواست وب، بدون کرون
│
...
پیامک و زمان‌بندی و لوگو می‌داند.
...
| `scheduler.php` | اجرای دستی کارهای دوره‌ای — ابزار تشخیص، نه زمان‌بند |
| `check-domain.sh` | آزاد بودن دامنه — برای انتخاب نام پلتفرم |
