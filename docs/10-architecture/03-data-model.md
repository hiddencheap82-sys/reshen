...
0022 support_tickets       ★ تیکت پشتیبانی، دوطرفه بین سالن و پلتفرم
0023 new_booking_awareness ★ سالن بفهمد نوبت اینترنتیِ تازه آمده
0024 bookings_seen_baseline  «ندیده» از روزِ عضویت شمرده شود، نه هیچ‌وقت
```
